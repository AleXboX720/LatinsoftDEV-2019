...
use App\Modelos\Vistas\ViewListarUsuarios;
...
class UsuariosController extends Controller
{
    public function index(Request $request)
    {
        ...
        $listado = ViewListarUsuarios::where('docu_empre', $this->_docu_empre)->paginate(15);
        return view('administrador.usuarios.vista', compact('title', 'back', 'search', 'listado'));
    }
