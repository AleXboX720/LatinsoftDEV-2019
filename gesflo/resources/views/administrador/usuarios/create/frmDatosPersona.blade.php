                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5">
                    	{{ Form::select('idde_nacio', 
                    		...
                    		null, ['class' => 'form-control text-uppercase', 'id' => 'idde_nacio', 'placeholder' => 'Seleccionar Nacionalidad']) 
                    	}}
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10">
                    	{{ Form::select('idde_ecivi', 
                    		...
                    		null, ['class' => 'form-control text-uppercase', 'id' => 'idde_ecivi', 'placeholder' => 'Seleccionar Estado Civil']) 
                    	}}
                    </div>
                </div>
            </div>
