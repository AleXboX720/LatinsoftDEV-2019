            ...
            <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10">
                    	{{ Form::text('codi_usuar', null, ['class' => 'form-control text-uppercase', 'id' => 'codi_usuar', 'maxlength' => '8', 'placeholder' => 'Codigo', 'readonly' => 'readonly']) }}
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10">
                    	{{ Form::password('pass_usuar', ['class' => 'form-control text-uppercase', 'id' => 'pass_usuar', 'maxlength' => '15', 'placeholder' => 'Contraseña']) }}
                        <em id="helpBlock" class="help-block hidden-sm hidden-xs"><small>(El Maximo de Caracteres Permitidos es de 15)</small></em>
                    </div>
                </div>

                <div class="form-group">
                    {{ Form::label('idde_tipo', 'Tipo', ['class' => 'col-md-2 col-lg-2 hidden-sm hidden-xs control-label']) }}
                    <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10">
                        {{ Form::select('idde_tipo', 
                            $lstTiposUsuario, 
                            null, ['class' => 'form-control text-uppercase', 'id' => 'idde_tipo', 'placeholder' => 'Seleccionar']) 
                        }}
