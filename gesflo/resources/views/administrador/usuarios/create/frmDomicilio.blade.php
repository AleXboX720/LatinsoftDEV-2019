        ...
        <div class="row">
            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                {{ Form::select('idde_provi', 
                    ...
                    null, ['class' => 'form-control text-uppercase', 'id' => 'idde_provi', 'placeholder' => 'Seleccionar Provincia']) 
                }}
            </div>
            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                {{ Form::select('idde_ciuda', 
                    ...
                    null, ['class' => 'form-control text-uppercase', 'id' => 'idde_ciuda', 'placeholder' => 'Seleccionar Ciudad']) 
                }}
            </div>
        </div>
    </div>
