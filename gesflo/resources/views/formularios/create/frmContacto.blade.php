    ...
    <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10">
        <div class="row">
            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                {{ Form::number('tele_conta', 0, ['class' => 'form-control text-uppercase', 'id' => 'tele_conta', 'max' => '9999999', 'placeholder' => 'Telefono']) }}
            </div>
            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                {{ Form::number('movi_conta', 0, ['class' => 'form-control text-uppercase', 'id' => 'movi_conta', 'max' => '999999999', 'placeholder' => 'Celular']) }}
            </div>
        </div>
    </div>
</div>
