	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Cobrar Multa</h4>
			</div>
										...
										<div class="form-horizontal">
											<div class="form-group">
												<div class="hidden-sm hidden-xs col-md-1">
										            {{ Form::label('docu_condu', 'Coductor', ['class' => 'hidden-sm hidden-xs control-label']) }}
										        </div>
										        <div class="col-md-3">
										            {{ Form::text('docu_condu', null, ['class' => 'form-control', 'id' => 'docu_condu', 'readonly']) }}
										        </div>
										        <div class="col-md-8">
